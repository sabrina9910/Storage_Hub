      ...
      <div className="glass-card w-full max-w-md p-8 text-center space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left">
          <div>
            ...
            />
            {errors.email && <span className="text-xs text-error mt-1">{(errors.email as any).message}</span>}
          </div>
          ...
          <div>
            ...
            <input 
              ...
              placeholder="••••••••"
            />
            {errors.password && <span className="text-xs text-error mt-1">{(errors.password as any).message}</span>}
          </div>
        ...
        <div className="pt-6 border-t border-slate-100 flex flex-col gap-3">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button 
                ...
                className="text-xs font-medium py-2 px-1 rounded-lg bg-purple-50 hover:bg-purple-100 text-purple-700 transition-colors border border-purple-200 shadow-sm"
            >
                Superuser
            </button>
            <button 
                ...
                className="text-xs font-medium py-2 px-1 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 transition-colors border border-blue-200 shadow-sm"
            >
                Manager
            </button>
            <button 
                ...
                className="text-xs font-medium py-2 px-1 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-700 transition-colors border border-emerald-200 shadow-sm"
            >
                Worker
            </button>
          </div>
